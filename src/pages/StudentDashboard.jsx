    ...
    <StudentLayout>
      <div className="p-4 md:p-8">
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <h1 className="text-2xl md:text-3xl font-bold text-white mb-2">Welcome back, Student Name 👋</h1>
          <p className="text-sm md:text-base text-gray-300">Here's a snapshot of your training progress</p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-6 mb-6 md:mb-8">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}>
            <Card className="bg-gradient-to-br from-[#1A4D2E] to-[#0D2818] border-[#2D6A4F]/50 p-4 md:p-6">
              <div className="flex items-center gap-2 md:gap-3 mb-2">
                ...
                <p className="text-gray-400 text-xs md:text-sm">Sessions Attended</p>
              </div>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
            <Card className="bg-gradient-to-br from-[#1A4D2E] to-[#0D2818] border-[#2D6A4F]/50 p-4 md:p-6">
              ...
              <p className="text-2xl md:text-3xl font-bold text-white">93%</p>
            </Card>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
            <Card className="bg-gradient-to-br from-[#1A4D2E] to-[#0D2818] border-[#2D6A4F]/50 p-4 md:p-6">
              <div className="flex items-center gap-2 md:gap-3 mb-2">
                ...
                <p className="text-gray-400 text-xs md:text-sm">Upcoming Sessions</p>
              </div>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }}>
            <Card className="bg-gradient-to-br from-[#1A4D2E] to-[#0D2818] border-[#2D6A4F]/50 p-4 md:p-6">
              <div className="flex items-center gap-2 md:gap-3 mb-2">
                <Wallet className="w-4 md:w-5 h-4 md:h-5 text-[#F4D03F]" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6 mb-6 md:mb-8">
          ...
          <div className="lg:col-span-2">
            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}>
              <Card className="bg-gradient-to-br from-[#1A4D2E] to-[#0D2818] border-[#2D6A4F]/50 p-4 md:p-6">
                <h2 className="text-lg md:text-xl font-bold text-white mb-4 md:mb-6">Attendance Trend</h2>
