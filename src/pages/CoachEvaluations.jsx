      ...
      <div className="p-4 md:p-8">
        ...
        <Dialog open={showEvaluationForm} onOpenChange={setShowEvaluationForm}>
          <DialogContent className="bg-[#0D2818] border-[#2D6A4F] max-w-2xl p-4 md:p-6">
            ...
            <div className="space-y-3 md:space-y-6 max-h-[70vh] overflow-y-auto">
              {/* Student Info */}
              <div className="bg-[#0A1F0A]/50 rounded-lg p-3 md:p-4">
                <p className="text-gray-400 text-xs md:text-sm">Batch: {selectedStudent?.batch}</p>
              </div>

              {/* Overall Score Display */}
              <div className="bg-gradient-to-r from-[#1A4D2E] to-[#0D2818] rounded-lg p-3 md:p-4 text-center border border-[#2D6A4F]/50">
                <p className="text-gray-400 text-xs md:text-sm mb-1 md:mb-2">Overall Score</p>
                <p className="text-[#D4AF37] text-3xl md:text-4xl font-bold">{overallScore}/10</p>
              </div>

              {/* Skill Sliders */}
              <div className="space-y-3 md:space-y-4">
                <h3 className="text-white font-semibold text-sm md:text-base">Rate Skills (1-10)</h3>
                
                {/* Batting */}
                <div>
                  <div className="flex justify-between mb-1 md:mb-2">
                    <p className="text-gray-300 text-xs md:text-sm">Batting</p>
                    <p className="text-white font-semibold text-xs md:text-sm">{evaluation.batting}/10</p>
                  </div>
                  <Slider
                ...
                <div>
                  <div className="flex justify-between mb-1 md:mb-2">
                    <p className="text-gray-300 text-xs md:text-sm">Bowling</p>
                    <p className="text-white font-semibold text-xs md:text-sm">{evaluation.bowling}/10</p>
                  </div>
                  <Slider
                ...
                <div>
                  <div className="flex justify-between mb-1 md:mb-2">
                    <p className="text-gray-300 text-xs md:text-sm">Fielding</p>
                    <p className="text-white font-semibold text-xs md:text-sm">{evaluation.fielding}/10</p>
                  </div>
                  <Slider
                ...
                <div>
                  <div className="flex justify-between mb-1 md:mb-2">
                    <p className="text-gray-300 text-xs md:text-sm">Teamwork</p>
                    <p className="text-white font-semibold text-xs md:text-sm">{evaluation.teamwork}/10</p>
                  </div>
                  <Slider
              ...
              {/* Notes */}
              <div>
                <h3 className="text-white font-semibold mb-1 md:mb-2 text-sm md:text-base">Evaluation Notes</h3>
                <Textarea
                  placeholder="Add feedback..."
                  value={evaluation.notes}
                  onChange={(e) => setEvaluation(prev => ({ ...prev, notes: e.target.value }))}
                  className="bg-[#0A1F0A]/50 border-[#2D6A4F] text-white min-h-24 md:min-h-32 text-xs md:text-sm"
                />
              </div>
              ...
              <div className="flex gap-2 md:gap-3">
                <Button
                  ...
                  variant="outline"
                  className="flex-1 border-[#2D6A4F] text-gray-300 text-xs md:text-sm h-8 md:h-10"
                >
                ...
                <Button
                  ...
                  className="flex-1 bg-gradient-to-r from-[#D4AF37] to-[#F4D03F] text-[#0A1F0A] hover:from-[#F4D03F] hover:to-[#D4AF37] text-xs md:text-sm h-8 md:h-10"
                >
