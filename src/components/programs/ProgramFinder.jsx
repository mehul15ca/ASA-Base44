...
const sports = [
  ...
  { id: 'stem', name: 'STEM Program', icon: '🔬' },
];
...
const programDatabase = {
  ...
  stem: {
    youth: {
      beginner: {
        name: 'STEM Sports Explorers',
        price: '$129/month',
        duration: '40 weeks/year',
        schedule: 'Mon & Sat 4-6 PM',
        focus: ['Basic physics of sports', 'Data collection & charts', 'Simple experiments'],
        groupSize: '8-10 kids',
        coach: 'Dr. Emily Watson',
      },
      intermediate: {
        name: 'Junior STEM Athletes',
        price: '$159/month',
        duration: '40 weeks/year',
        schedule: 'Mon, Wed & Sat 4-6 PM',
        focus: ['Sports biomechanics', 'Technology in training', 'Performance analysis'],
        groupSize: '6-8 kids',
        coach: 'Dr. Emily Watson',
      },
    },
    junior: {
      beginner: {
        name: 'Teen Sports Science',
        price: '$149/month',
        duration: '40 weeks/year',
        schedule: 'Tue, Thu & Sat 5-7 PM',
        focus: ['Physics of motion', 'Data science basics', 'Equipment engineering'],
        groupSize: '8-10 teens',
        coach: 'Dr. Emily Watson',
      },
      intermediate: {
        name: 'Advanced Sports Technology',
        price: '$179/month',
        duration: '40 weeks/year',
        schedule: 'Mon-Thu 5-7 PM',
        focus: ['Video analysis systems', 'Performance tracking', 'Statistical analysis'],
        groupSize: '6-8 teens',
        coach: 'Dr. Emily Watson',
      },
      advanced: {
        name: 'Elite Sports Science Program',
        price: '$229/month',
        duration: '46 weeks/year',
        schedule: '5 days/week',
        focus: ['Advanced biomechanics', 'Research projects', 'College prep portfolio'],
        groupSize: '4-6 teens',
        coach: 'Dr. Emily Watson',
      },
    },
    adult: {
      beginner: {
        name: 'Adult Sports Science Basics',
        price: '$139/month',
        duration: '36 weeks/year',
        schedule: 'Wed & Sat 7-9 PM',
        focus: ['Sports physics', 'Nutrition science', 'Performance metrics'],
        groupSize: '10-12 adults',
        coach: 'Dr. Emily Watson',
      },
      intermediate: {
        name: 'Applied Sports Technology',
        price: '$169/month',
        duration: '40 weeks/year',
        schedule: 'Tue, Thu & Sun 7-9 PM',
        focus: ['Video analysis', 'Data-driven training', 'Wearable tech integration'],
        groupSize: '8-10 adults',
        coach: 'Dr. Emily Watson',
      },
    },
